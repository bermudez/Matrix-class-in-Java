/*************************************************************************
 *  Compilation:  javac TestClient3.java
 *  Execution:    java TestClient3
 *
...
public class TestClient3 extends Matrix {



    public TestClient3(double[][] data) {
		super(data);
	...
	*********END OF DEBUGGING OUTPUT*/
     ...
     // print time elapsed
		...
		System.out.format("%n%n***ALL OPERATIONS COMPLETED.***%n%n");
		System.out.format("%n%nElapsed Time is:  %f seconds.%n%n", estimatedTime/1000000000);  

		//************
		//OUTPUT MEMORY INFORMATION
		//************
        System.out.format("    " +
          	     " %,d = number of matrices created  (each matrix is %,d x %,d).%n",
          	                   maxNumberOfMatrices, sizeOfM, sizeOfM); 
